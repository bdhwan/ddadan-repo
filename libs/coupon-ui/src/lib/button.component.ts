...
@Component({
  ...
  styles: `
    ...
    :host.full-width, :host.full-width button { width: 100%; }
    button {
      min-height: 44px;
      padding: .7rem 1rem;
    ...
    button.secondary { background: transparent; color: var(--coupon-color-text); border-color: var(--coupon-color-border); }
    button.danger { background: var(--coupon-color-danger); border-color: var(--coupon-color-danger); color: var(--coupon-color-surface); }
