...
export class CatalogApi {
  ...
  list(): Observable<CatalogItemListResponseDto> {
    return this.http.get<CatalogItemListResponseDto>(this.base);
  }
  create(payload: SaveCatalogItemRequestDto): Observable<CatalogItemDto> {
    return this.http.post<CatalogItemDto>(this.base, payload);
  }
  update(
    id: string,
    payload: SaveCatalogItemRequestDto,
  ): Observable<CatalogItemDto> {
    return this.http.patch<CatalogItemDto>(`${this.base}/${id}`, payload);
  }
}
